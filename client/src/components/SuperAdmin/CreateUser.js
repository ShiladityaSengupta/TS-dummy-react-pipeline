    ...
    render() {
        ...
        return (
            ...
            Female
                                ...
                                <div className="row">
                                    <div className="col-lg-4">
                                        <input type="submit" value="Create User" className="btn btn-success" style={{ 'margin-right': 10 }} />
                                        <a className="btn btn-danger" href="/SuperAdmin/Registration" style={{ 'margin-right': 10 }} >Clear</a>

                                        <a className="btn btn-info" href="/SuperAdmin/AllUsers/Users">All Users</a>
                            ...
                            </form>
                            {
                                this.state.UserAdded ?
                                    <div className="p-3 mb-2 bg-success text-white" style={{ margin: 'auto', width: '50%', padding: '10px', textAlign: "center", marginTop:10  }}>User '{this.state.Username}' created successfully</div>
                                    :
                                    <div></div>
                            }
        </div>
